...
INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(10,'Will', 'Murphy', 4, $7800, 5, 'murphywill@mail.com', +212143323, 5)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(11,'Alexandra', 'Slavova', 5, $5500, 1, 'alexsavova@mail.com', +35943323, 8)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(12,'Pavlin', 'Tomov', 6, $4300, 1, 'pavlintomov@mail.com', +35954423, 11)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(13,'Igor', 'Ivanov', 6, $4300, 1, 'pavlintomov@mail.com', +35954423, 11)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(14,'George', 'Rigov', 7, 2100, 2, 'gogog@mail.com', +35912223, 12)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(15,'Teodor', 'Todorow', 8, 1000, 1, 'teotoe@mail.com', +35900923, 14)

INSERT Employees(EmployeeID,FirstName,LastName,JobPositionID,Salary,TownID,Email,Phone,ManagerID)
VALUES(16,'Yung', 'Ing', 8, 1000, 5, 'yunging@mail.com', +1120923, null)
